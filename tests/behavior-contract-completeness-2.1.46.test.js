...
const requiredIntentPhrases = [
  ...
  "A text keypress cancels every fresh parser/render/layout task",
  "No complete editor snapshot or popup refresh may run before 500 ms of keyboard idle",
  "sole exception is revealing already-rendered cached popup markup",
  "After idle, an already-open equation or figure/table caption updates the same mounted popup",
  "During an actual editor scroll, all SmartTeX overlays are hidden by CSS",
  ...
  "Stable cache identity uses document + logical kind + environment ordinal + environment-body hash",
